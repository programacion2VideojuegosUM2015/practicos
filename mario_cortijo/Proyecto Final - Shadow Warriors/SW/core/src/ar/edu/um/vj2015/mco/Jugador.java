     ...
     public void TestAnimation() { 	 
    	 Timer.schedule(new Task(){
             ...
             public void run() {
               ...
               //----------------------------------------------------------
                 if(ryuEstado=="Punch") {
                	 if (frame == 1) {ryuCurrentFrame = ryuPunch01; if(combo==3){combo = 0;} } 
                     if (frame == 2) {ryuCurrentFrame = ryuPunch02; if(damage==0){damage=1;} if(combo<3 && Juego.jugador1Ocupado==1){combo++;} soundRoundhouse1.play(); }
                 ...
                 if(ryuEstado=="Kick") {
                	 if (frame == 1) {ryuCurrentFrame = ryuKick01; if(combo==3){combo = 0;} }
                     if (frame == 2) {ryuCurrentFrame = ryuKick02; if(damage==0){damage=1;} if(combo<3 && Juego.jugador1Ocupado==1){combo++;} soundRoundhouse3.play(); }
                 ...
                 //----------------------------------------------------------
                  ...
                  //  ANIMACION CAMINAR
                  //----------------------------------------------------------
                    if(ryuEstado=="Walk" || ryuEstado=="AutoWalk") {
                  ...
                  //----------------------------------------------------------
                  //  ANIMACION CAMINAR APRA ATRAS
                  //----------------------------------------------------------
                    if(ryuEstado=="ReverseWalk") {
                  	 if (frame == 1) {ryuCurrentFrame = ryuWalk06;}
                   	 if (frame == 3) {ryuCurrentFrame = ryuWalk05;}	 
                     if (frame == 5) {ryuCurrentFrame = ryuWalk04;}
                     if (frame == 7) {ryuCurrentFrame = ryuWalk03;}
                     if (frame == 9) {ryuCurrentFrame = ryuWalk02;}
                     if (frame == 11) {ryuCurrentFrame = ryuWalk01;} 
                    } 
                  //----------------------------------------------------------
                  //  ANIMACION GOLPEADO
                  //----------------------------------------------------------
                 ...
                 //----------------------------------------------------------
                   if(ryuEstado=="Dead") {
                       ...
                       if (frame == 36) {ryuCurrentFrame = ryuBlank;
                                          ...
                                          if(vidas<=0){
                                        	ryuEstado="Dead";
                                        	ryuCurrentFrame = ryuDie05;
                                        	speedTimer = 100/30.0f;
                                          }
               ...
               //----------------------------------------------------------
                 if(ryuEstado=="Stance") {
                     ...
                     if (frame == 4) {Juego.jugador1Ocupado = 0;}
                 }
               //----------------------------------------------------------
               //  ANIMACION SALTO
               //----------------------------------------------------------  
