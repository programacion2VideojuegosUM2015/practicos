...
public class NinjaEnemigo {
	...
	public NinjaEnemigo (){
	  dropHitbox = new Rectangle (getEnemyX(), getEnemyY(), 40, 3);
	...
	// MÉTODOS
	//-----------------------------------------------------------------------------------------
	public Texture getNinjaCurrentFrame() { return ninjaCurrentFrame; }
    public void setNinjaCurrentFrame(Texture ninjaCurrentFrame) { this.ninjaCurrentFrame = ninjaCurrentFrame; }	
	//-----------------------------------------------------------------------------------------
            ...
            public void run() {
              ...
              //----------------------------------------------------------
                if(estadoEnemy=="Ataque") {
                 ...
                 if (frame == 5) {ninjaCurrentFrame = ninjaPunch01;}
                 if (frame == 6) {ninjaCurrentFrame = ninjaPunch02;combo=1; soundRoundhouse1.play();}
                 if (frame == 8) {ninjaCurrentFrame = ninjaPunch03;combo=0;}
                 ...
                 if (frame == 20) {ninjaCurrentFrame = ninjaStance;} 
                }
                //----------------------------------------------------------
                //  ANIMACION CORRER
                //----------------------------------------------------------
              ...
              //----------------------------------------------------------
                  if(estadoEnemy=="FinSalto") {
                    if (frame == 1) {ninjaCurrentFrame = ninjaJump02;}
